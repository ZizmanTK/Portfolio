...
export class AboutPageComponent implements AfterViewInit {
  ...
  cards: CardData[] = [
    {
      imageUrl: this.imageFolder + 'volley-ball.png',
      heading: 'Volley Ball',
      details:
    ...
    // {
    //   imageUrl: this.imageFolder + 'chip-ai.png',
    ...
    // },
    // {
    //   imageUrl: this.imageFolder + 'foot-ball.png',
    //   heading: 'Soccer',
    //   details:
    //     'Amateur player, I have powerful spikes and very good defense against tips. During my highshool, I won an interlycée tournament with my school team, playing as main setter (the most strategic position... just saying)',
    // },
  ...
  moveSpotLight(event: MouseEvent) {
    const spotlight = document?.getElementById('spotlight'); //do this once
